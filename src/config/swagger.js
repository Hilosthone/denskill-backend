...
const options = {
  definition: {
    ...
    // Global security requirement ensures Swagger automatically passes 
    // the authorization bearer token to routes that expect authentication.
    security: [
      {
        bearerAuth: [],
      },
...
const swaggerDocs = (app) => {
  // Serve raw JSON specification payload
  app.get('/api-docs.json', (req, res) => {
    res.setHeader('Content-Type', 'application/json')
    res.send(swaggerSpec)
  })

  // Serve interactive Swagger UI HTML dashboard using official CDN assets
