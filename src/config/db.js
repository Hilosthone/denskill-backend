...
// // Automatically ensure scholarship tables exist on startup
// pool
//   .query(
//     `
//     -- 1. Update users table columns for scholarship tagging
//     ALTER TABLE users ADD COLUMN IF NOT EXISTS student_type VARCHAR(50) DEFAULT 'NORMAL';
...
//   )
//   .then(() =>
//     console.log('✅ Database migration checked: scholarship tables verified.'),
//   )
//   .catch((err) =>
