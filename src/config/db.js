...
//       created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
//     );
//     ALTER TABLE enrollments ADD COLUMN IF NOT EXISTS course_id INTEGER REFERENCES courses(id) ON DELETE SET NULL;
//   `,
//   )
//   .then(() =>
//     console.log('✅ Database migration checked: enrollments table verified.'),
...
// // Automatically ensure instructors, assessments, student_submissions, attendance, modules, sessions & announcements match controller expectations
// pool
//   .query(
//     `
...
//     -- 2. Assessments Table (Aligned with tutorController)
//     CREATE TABLE IF NOT EXISTS assessments (
//       id SERIAL PRIMARY KEY,
...
//     -- 3. Student Submissions Table (Aligned with grading & feedback)
//     CREATE TABLE IF NOT EXISTS student_submissions (
//       id SERIAL PRIMARY KEY,
//       student_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
//       assessment_id INTEGER REFERENCES assessments(id) ON DELETE CASCADE,
...
//       created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
//     );
//     ALTER TABLE student_submissions ADD COLUMN IF NOT EXISTS graded_by INTEGER REFERENCES instructors(id) ON DELETE SET NULL;

//     -- 4. Attendance Logs Table (Aligned with logAttendance query & unique conflict constraint)
//     CREATE TABLE IF NOT EXISTS attendance_logs (
//       id SERIAL PRIMARY KEY,
//       student_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
//       course_id INTEGER REFERENCES courses(id) ON DELETE CASCADE,
...
//       status VARCHAR(50) DEFAULT 'present',
//       logged_by INTEGER REFERENCES instructors(id) ON DELETE SET NULL,
//       created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
//       CONSTRAINT unique_student_course_date UNIQUE (student_id, course_id, session_date)
//     );

//     -- 5. Course Modules Table (Aligned with uploadCourseModule)
...
//     -- 6. Live Sessions Table (Aligned with scheduleLiveSession)
...
//       description TEXT,
//       tutor_id INTEGER REFERENCES instructors(id) ON DELETE SET NULL,
//       created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
//     );

//     -- 7. Course Announcements Table (Matched to createCourseAnnouncement)
